	          ...
	          <!-- /.card-header -->
	          	<div class="card-body">
	          		<form action="{{route('user.insert')}}" method="POST">
	                    ...
	                    <input type="text" class="form-control @if ($errors->has('tai_khoan')) is-invalid @endif" value="{{ old('tai_khoan') }}" name="tai_khoan" id="name" placeholder="Nhập tên tài khoản">
	                    ...
	                    <input type="text" class="form-control @if ($errors->has('email')) is-invalid @endif" value="{{ old('email') }}" name="email" id="name" placeholder="Nhập email">
	                     @if ($errors->has('email'))
	                    ...
	                    <select name="phan_quyen" class="form-control @if($errors->has('phan_quyen')) is-invalid @endif " >
	                    	...
	                    	<option value="0" @if(old('phan_quyen')==0) selected @endif >Admin</option>
	                    	<option value="1" @if(old('phan_quyen')==1) selected @endif >Nhân viên</option>
	                    </select>
		                ...
		                <div class="form-group">
	                    <label for="exampleInputEmail1">Nhập lại mật khẩu<span class="text-danger">*</span></label>
